...
{
   public class UpdateProductsCommand : IRequest<List<Product>>
    {
    ...
    public class UpdateProductsCommandHandler : IRequestHandler<UpdateProductsCommand, List<Product>>
    {
      //  private readonly IFractolDbContext _context;
        ...
        public async Task<List<Product>> Handle(UpdateProductsCommand request, CancellationToken cancellationToken)
        {
