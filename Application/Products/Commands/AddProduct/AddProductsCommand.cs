...
namespace Application.Products.Commands.AddProducts
{
   public class AddProductsCommand : IRequest<List<Product>>
    {
    ...
    public class AddProductsCommandHandler : IRequestHandler<AddProductsCommand, List<Product>>
    {
      //  private readonly IFractolDbContext _context;
        ...
        public async Task<List<Product>> Handle(AddProductsCommand request, CancellationToken cancellationToken)
        {
